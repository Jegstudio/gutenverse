...
import contentHoverStyle from './panel-style/style-content-hover';
import contentOverlayStyle from './panel-style/style-content-overlay';
import contentStyle from './panel-style/style-content';
import descStyle from './panel-style/style-desc';
import imageStyle from './panel-style/style-image';
import jobStyle from './panel-style/style-job';
import nameStyle from './panel-style/style-name';
import teamStyle from './panel-style/style-team';
import { backgroundStyle } from 'gutenverse-core/controls';

const getBlockStyle = (elementId, attributes) => {
    let data = [];

    data = contentHoverStyle(elementId, attributes, data);
    data = contentOverlayStyle(elementId, attributes, data);
    data = contentStyle(elementId, attributes, data);
    data = descStyle(elementId, attributes, data);
    data = imageStyle(elementId, attributes, data);
    data = jobStyle(elementId, attributes, data);
    data = nameStyle(elementId, attributes, data);
    data = teamStyle(elementId, attributes, data);
