            ...
            >
                {showLabel && (
                    <PlainText
                        ...
                        tagName="span"
                        aria-label={__('Next page link', 'gutenverse')}
                        placeholder={__('Next Page', 'gutenverse')}
                        value={label}
                        onChange={(newLabel) =>
                ...
                {displayArrow && (
                    <span
                        className={`wp-block-gutenverse-dynamic-pagination-next-arrow is-arrow-${paginationArrow}`}
                        aria-hidden
                    >
                        {displayArrow}
                    </span>
