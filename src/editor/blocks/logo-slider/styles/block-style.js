...
const getBlockStyle = (elementId, attributes) => {
    let data = [];
    data = panelArrowStyle(elementId, attributes, data);
    data = panelDotsStyle(elementId, attributes, data);
    data = panelLogosStyle(elementId, attributes, data);
    data = panelLogosWrapperStyle(elementId, attributes, data);
