...
import arrowStyle from './panel-style/style-arrow';
import contentTypographyStyle from './panel-style/style-content-typography';
import contentStyle from './panel-style/style-content';
import dotsStyle from './panel-style/style-dots';
import imageStyle from './panel-style/style-image';
import ratingStyle from './panel-style/style-rating';
import { backgroundStyle } from 'gutenverse-core/controls';

const getBlockStyle = (elementId, attributes) => {
    let data = [];

    data = arrowStyle(elementId, attributes, data);
    data = contentTypographyStyle(elementId, attributes, data);
    data = contentStyle(elementId, attributes, data);
    data = dotsStyle(elementId, attributes, data);
    data = imageStyle(elementId, attributes, data);
    data = ratingStyle(elementId, attributes, data);
    ...
    return [
        ...data,
        ...applyFilters(
            'gutenverse.testimonials.blockStyle',
            [],
            {
                elementId,
                attributes
