<?php
/**
 * Gutenverse Dynamic Pagination Next Style
 *
 * @author Jegstudio
 * @since 1.0.0
...
/**
 * Class Dynamic_Pagination_Next
 *
 * @package gutenverse\style
 */
class Dynamic_Pagination_Next extends Style_Abstract {
	/**
	 * Block Name
	 *
	 * @var array
	 */
	protected $name = 'dynamic-pagination-next';
	...
	public function generate() {
		...
		if ( isset( $this->attrs['paginationIconSpacing'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .btn-pagination.next i, .{$this->element_id} .btn-pagination.next svg",
					'property'       => function ( $value ) {
		...
		if ( isset( $this->attrs['paginationIconSize'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .btn-pagination.next i",
					'property'       => function ( $value ) {
			...
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .btn-pagination.next svg",
					'property'       => function ( $value ) {
